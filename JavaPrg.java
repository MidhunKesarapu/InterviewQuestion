...
public class lorques {
    public static void main(String[] args) {
        String fileName = "/Users/midhunkesarapu/Downloads/voting.dat"; // Specify the path to your .dat file
...
//        // Display the unique region names
//        System.out.println("Unique regions:");
//        for (String region : regions) {
//            System.out.println(region);
//        }
//        
//        // Display the contestants for each region
//        System.out.println("Contestants for each region:");
//        for (String contestantsList : contestants) {
//            System.out.println(contestantsList);
//        }
//
//        // Display the data from the specified line number onwards
//        System.out.println("Data from line " + startLine + " onwards:");
...
//                String winnerKey = winnerList.getKey(i); // Assuming winnerList is a TreeMap<String, Integer>
//                int winnerValue = winnerList.getValue(i); // Assuming winnerList is a TreeMap<String, Integer>
//                System.out.println("Region: " + region + ", Winner: " + winnerKey + ", Votes: " + winnerValue);
//            }
